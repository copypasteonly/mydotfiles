...
local config = require('coq').lsp_ensure_capabilities({
  ...
  cmd = {
    ...
    -- 💀
    '-jar', '/home/denzel/.local/opt/jdtls-launcher/jdtls/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
         -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    '-configuration', '/home/denzel/.local/opt/jdtls-launcher/jdtls/config_linux/',
                    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
